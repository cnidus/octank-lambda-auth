...
module.exports = {
    google: {
      client_id: '413991723922-esf5ihdq7pah5nso6tvco0jnta5hekv0.apps.googleusercontent.com',
      client_secret: 'scrambled',
    ...
    facebook: { // https://developers.facebook.com/docs/facebook-login/manually-build-a-login-flow
      client_id: '1714717308847323', //CloudApp
      client_secret: 'scrambled',
    ...
    stage: {
      dev: {
        ...
        redirect_url: 'https://octank-ml.prabhatsharma.com'
      },
      app: {
        application_url: 'https://octank-ml.prabhatsharma.com',
        redirect_url: 'https://octank-ml.prabhatsharma.com'
      }
    },
}
